        ...
        <CardContent className="pt-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-2 sm:col-span-2">
              <Label htmlFor="keyword-input" className="text-xs font-semibold text-slate-700 flex items-center justify-between">
              ...
              <p className="text-[11px] text-slate-500">
                Type a role or skill and press <kbd className="px-1.5 py-0.5 bg-slate-100 text-slate-700 rounded font-mono text-[10px] border border-slate-200">Enter</kbd> or <kbd className="px-1.5 py-0.5 bg-slate-100 text-slate-700 rounded font-mono text-[10px] border border-slate-200">,</kbd> to convert it into a pill. Pressing <kbd className="px-1.5 py-0.5 bg-slate-100 text-slate-700 rounded font-mono text-[10px] border border-slate-200">Backspace</kbd> on an empty input deletes the last pill.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-1.5 sm:col-span-2">
              <Label htmlFor="recipient" className="text-xs font-semibold text-slate-700 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
