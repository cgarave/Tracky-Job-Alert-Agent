...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 opacity-70 transition-all hover:opacity-100 hover:bg-slate-100 text-slate-400 hover:text-slate-700 focus:outline-none">
        <X className="h-4 w-4" />
