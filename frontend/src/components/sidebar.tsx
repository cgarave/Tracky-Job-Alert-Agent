  ...
  return (
    <aside className="w-64 border-r border-slate-800 bg-slate-950/80 backdrop-blur-2xl flex flex-col p-5 h-screen sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3.5 pb-5 border-b border-slate-800 mb-5">
        <div className="relative w-10 h-10 rounded-xl overflow-hidden shadow-md shadow-blue-500/10 border border-slate-800">
          <Image
            src="/logo.png"
            alt="Tracky Logo"
            fill
      ...
      <div className="pt-4 border-t border-slate-800 flex flex-col gap-3 mt-auto">
        ...
        <Button
          onClick={onScanNow}
          disabled={isScanning}
          className="w-full gap-2 font-medium text-xs h-9 bg-blue-600 hover:bg-blue-500 text-white shadow-md shadow-blue-500/20"
        >
